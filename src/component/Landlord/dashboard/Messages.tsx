    ...
    <div className="p-6 h-[calc(100vh-6rem)] flex flex-col">
      ...
      <div className="grid md:grid-cols-3 gap-6 flex-1 min-h-0">
        <div className="md:col-span-1 flex flex-col min-h-0">
          <div className={`rounded-xl border shadow-sm flex-1 flex flex-col overflow-hidden ${
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-1">
                          ...
                          <span className={`text-[10px] whitespace-nowrap ${
                            conv.unreadCount > 0 ? 'text-emerald-500 font-bold' : isDarkMode ? 'text-gray-500' : 'text-gray-400'
        ...
        <div className="md:col-span-2 flex flex-col min-h-0">
          {selectedConversation ? (
            <div className={`rounded-2xl border shadow-sm flex flex-col flex-1 overflow-hidden ${
              isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
            }`}>
              ...
              <div className={`p-4 border-t ${isDarkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
                <div className="flex items-end gap-3">
                   <textarea
                     ...
                     className={`flex-1 p-3 border rounded-xl outline-none max-h-32 resize-none focus:ring-2 focus:ring-emerald-500/50 ${
                       isDarkMode
            ...
            <div className={`rounded-2xl border shadow-sm h-full flex flex-col items-center justify-center text-center p-12 ${
              isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
            }`}>
