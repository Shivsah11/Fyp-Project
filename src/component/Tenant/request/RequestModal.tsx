...
const RequestModal = ({ isOpen, onClose, onRequestAdded }: RequestModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[100] p-4 transition-all duration-500">
      <div className={`rounded-[40px] p-8 md:p-10 border w-full max-w-2xl max-h-[90vh] overflow-y-auto no-scrollbar shadow-2xl relative transition-all duration-500 ${isDarkMode
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            onClick={onClose}
            className={`w-12 h-12 flex items-center justify-center rounded-2xl font-black text-2xl transition-all duration-300 ${isDarkMode ? 'bg-gray-800 text-gray-400 hover:text-white hover:bg-gray-700' : 'bg-gray-100 text-gray-400 hover:text-gray-900'
              }`}
          >
            ×
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {requestTypes.map((type) => (
                <button
                  ...
                  className={`p-4 rounded-2xl border transition-all duration-500 flex items-center gap-3 group transform hover:scale-[1.02] ${requestType === type.id
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-6 py-4 rounded-2xl font-bold transition-all duration-300 border focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none ${isDarkMode
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-6 py-4 rounded-2xl font-bold transition-all duration-300 border focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none resize-none ${isDarkMode
                  ? 'bg-gray-800/50 border-gray-700 text-white placeholder:text-gray-600'
                  : 'bg-gray-50 border-gray-200 text-gray-900 shadow-sm'
                }`}
            ...
            <div className="flex gap-4">
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-xl font-black text-[10px] uppercase tracking-widest border transition-all duration-500 hover:-translate-y-1 ${priority === level.value
          ...
          <button
            ...
            className={`w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest shadow-2xl transition-all duration-500 transform hover:scale-[1.02] disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed ${!isSubmitting && requestType && subject && description ? 'shadow-emerald-500/30 hover:shadow-emerald-500/50' : ''
              }`}
          >
