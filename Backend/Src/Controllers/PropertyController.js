...
export const createProperty = async (req, res) => {
  ...
  try {
    const { title, description, price, location, type, beds, baths, area, image, amenities, status } = req.body;
    const landlordId = req.user.userId;
...
export const updateProperty = async (req, res) => {
  try {
    ...
    property = await Property.findByIdAndUpdate(id, req.body, { new: true, runValidators: true });
